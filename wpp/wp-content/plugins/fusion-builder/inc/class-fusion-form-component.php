...
abstract class Fusion_Form_Component extends Fusion_Element {
	...
	public function generate_input_field( $args, $type = 'text' ) {
		...
		$element_html = '<input type="' . $type . '" name="' . $args['name'] . '" value="' . $args['value'] . '" ' . $element_data['class'] . $element_data['required'] . $element_data['placeholder'] . $element_data['style'] . $element_data['holds_private_data'] . $element_data['input_attributes'] . $element_data['pattern'] . '/>';
	...
	public function checkbox( $args, $type = 'checkbox' ) {
		...
		foreach ( $args['options'] as $key => $option ) {
			...
			$options       .= '<input id="' . $label_id . '" type="' . $type . '" value="' . $value . '" name="' . $element_name . '"' . $element_data['class'] . $element_data['required'] . $checked . $element_data['holds_private_data'] . '/>';
