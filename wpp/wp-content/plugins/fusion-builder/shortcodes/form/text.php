			...
			[
				...
				'params'         => [
					...
					[
						...
						'description' => esc_attr__( 'Controls the minimum number of characters that will be allowed for this input field.  Leave at 0 to have no maximum.', 'fusion-builder' ),
