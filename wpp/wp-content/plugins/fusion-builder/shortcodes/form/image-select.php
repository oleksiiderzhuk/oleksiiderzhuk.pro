	...
	if ( ! class_exists( 'FusionForm_ImageSelect' ) ) {
		...
		class FusionForm_ImageSelect extends Fusion_Form_Component {
			...
			public function render_select_image( $args, $content = '' ) {
				...
				$html .= '<input id="' . esc_attr( $label_id ) . '" type="' . $input_type . '" value="' . esc_attr( $value ) . '" name="' . esc_attr( $element_name ) . '"' . $element_data['class'] . $element_data['required'] . $checked . $element_data['holds_private_data'] . '/>';
