    ...
    public function setBasePoint($x, $y)
    {
        switch (\true) {
            case !\is_string($x) && !$x instanceof BinaryInteger:
                throw new \UnexpectedValueException('LatePoint\\GoogleCalendarAddon\\Argument 1 passed to Binary::setBasePoint() must be a string or an instance of BinaryField\\Integer');
            case !\is_string($y) && !$y instanceof BinaryInteger:
                throw new \UnexpectedValueException('LatePoint\\GoogleCalendarAddon\\Argument 2 passed to Binary::setBasePoint() must be a string or an instance of BinaryField\\Integer');
        }
        if (!isset($this->factory)) {
            throw new \RuntimeException('setModulo needs to be called before this method');
        }
