...
use LatePoint\GoogleCalendarAddon\PhpConsole\Connector;
use LatePoint\GoogleCalendarAddon\PhpConsole\Handler as VendorPhpConsoleHandler;
use LatePoint\GoogleCalendarAddon\PhpConsole\Helper;
/**
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    {
        if (!\class_exists('LatePoint\\GoogleCalendarAddon\\PhpConsole\\Connector')) {
