...
use LatePoint\GoogleCalendarAddon\Swift_Message;
use LatePoint\GoogleCalendarAddon\Swift;
/**
...
class SwiftMailerHandler extends MailHandler
{
     ...
     */
    public function __construct(\LatePoint\GoogleCalendarAddon\Swift_Mailer $mailer, $message, $level = Logger::ERROR, bool $bubble = \true)
    {
