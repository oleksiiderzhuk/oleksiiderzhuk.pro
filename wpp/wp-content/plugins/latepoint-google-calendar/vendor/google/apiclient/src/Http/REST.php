...
class REST
{
    ...
    public static function doExecute(ClientInterface $client, RequestInterface $request, $expectedClass = null)
    {
        try {
            ...
            if (\interface_exists('LatePoint\\GoogleCalendarAddon\\GuzzleHttp\\Message\\ResponseInterface') && $response instanceof \LatePoint\GoogleCalendarAddon\GuzzleHttp\Message\ResponseInterface) {
