...
use LatePoint\GoogleCalendarAddon\GuzzleHttp\Message\ResponseInterface as Guzzle5ResponseInterface;
use LatePoint\GoogleCalendarAddon\GuzzleHttp\Promise\Promise;
use LatePoint\GoogleCalendarAddon\GuzzleHttp\Promise\RejectedPromise;
...
class Guzzle5HttpHandler
{
    ...
    {
        if (!\class_exists('LatePoint\\GoogleCalendarAddon\\GuzzleHttp\\Promise\\Promise')) {
