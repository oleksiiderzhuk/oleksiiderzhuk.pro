...
use LatePoint\GoogleCalendarAddon\phpseclib\Crypt\RSA;
use LatePoint\GoogleCalendarAddon\phpseclib\Math\BigInteger;
use LatePoint\GoogleCalendarAddon\Psr\Cache\CacheItemPoolInterface;
use RuntimeException;
use LatePoint\GoogleCalendarAddon\SimpleJWT\InvalidTokenException;
use LatePoint\GoogleCalendarAddon\SimpleJWT\JWT as SimpleJWT;
use LatePoint\GoogleCalendarAddon\SimpleJWT\Keys\KeyFactory;
use LatePoint\GoogleCalendarAddon\SimpleJWT\Keys\KeySet;
    ...
    private function setPhpsecConstants()
    {
        if (\filter_var(\getenv('GAE_VM'), \FILTER_VALIDATE_BOOLEAN)) {
            ...
            if (!\defined('LatePoint\\GoogleCalendarAddon\\CRYPT_RSA_MODE')) {
                \define('LatePoint\\GoogleCalendarAddon\\CRYPT_RSA_MODE', RSA::MODE_OPENSSL);
            }
        }
    }
    /**
