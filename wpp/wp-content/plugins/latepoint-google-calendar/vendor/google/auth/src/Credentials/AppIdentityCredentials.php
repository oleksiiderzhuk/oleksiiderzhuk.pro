 ...
 */
use LatePoint\GoogleCalendarAddon\google\appengine\api\app_identity\AppIdentityService;
...
class AppIdentityCredentials extends CredentialsLoader implements SignBlobInterface, ProjectIdProviderInterface
{
    ...
    {
        if (!self::onAppEngine() || !\class_exists('LatePoint\\GoogleCalendarAddon\\google\\appengine\\api\\app_identity\\AppIdentityService')) {
