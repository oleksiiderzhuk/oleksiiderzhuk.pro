...
$gennnnqu="select gender from $tab where id=$record";

	$gennnn=mysql_result((mysql_query($gennnnqu)), 0);
...
//echo 'мамаid: '.$idmo.'<br>';
	...
	$res = mysql_query('select name from $tab where gender="f"');
				...
				echo "<br><br><a href=\"/singleview.php?record=$idmo\" title=\"Мама\">".$result."</a>";
...
$idfa=null;
	...
	$res = mysql_query("select name from $tab where gender='m'");
				...
				if ($idfa==null) {
				echo "<br><br><a href=\"/singleview.php?record=2\">".$result."</a>";
				}	
else {				
				echo "<br><br><a href=\"/singleview.php?record=$idfa\">".$result."</a>";}
...
if ($nnn) {
if ($gennn=='m') {
echo "<b>супруга: </b><br><br>";
}
else {
echo "<b>супруг: </b><br><br>";
}
} 
echo "
<b>мама: </b><br><br>
...
echo "<a href=\"/singleview.php?record=$idpair\">".$nnn."</a><br><br>";
}
