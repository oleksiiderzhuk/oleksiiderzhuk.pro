...
<div class="container">
	<div class="row" style="margin-top: 60px;">
		<div class="col-md-12" align="center">
			...
			//--------------------
				echo "<h4>Кількість суб'єктів господарювання із державною реєстрацією припинення - <b>$activity_finish_num</b></h4>";

				$find = '';
				$find=mysqli_real_escape_string($link,$find);

				$sql = "SELECT * FROM person WHERE person_id IN (
				SELECT person_id FROM activity_finish WHERE regno_stopped NOT LIKE '' OR date_stopping NOT LIKE '0000-00-00') and state = '1' OR state = '3' ORDER BY date_start DESC LIMIT 170";
