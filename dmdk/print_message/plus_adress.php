	...
	<form method="post" style="margin-left: 200px">
		...
		<div style="margin-left: 66px; margin-top: 34px">
			...
			foreach($all_adress_today as $value):
				...
				?>
				<tr>
					<th style="font-weight: normal; text-align: center; padding: 5px; vertical-align: top; font-family: serif; font-size: 14pt"><?=$adr;?></th>
					<th style="font-weight: normal; text-align: justify; padding: 5px; vertical-align: top; font-family: serif; font-size: 14pt">
