...
<body>
	<form method="post" style="margin-left: 200px">
		<textarea id="myeditablediv">
			...
			<p style="text-indent: 45px; text-align: justify; font-family: serif; font-size: 14pt">Міністерство фінансів України повідомляє про внесення змін до реєстру суб'єктів господарювання, які здійснюють операції з дорогоцінними металами і дорогоцінним камінням, щодо операцій з дорогоцінними металами і дорогоцінним камінням за місцем провадження діяльності <?=$opf_alias.' '.$name?> (реєстраційний номер <?=$regno?>).</p>
			...
			2. Реєстраційне повідомлення від <?=$today?> про припинення операцій з дорогоцінними металами і дорогоцінним камінням за місцем провадження діяльності на 1 арк. в 1 прим.;
			</div>
			<div style="text-align: justify; font-family: serif; font-size: 14pt">
			3. Реєстраційне повідомлення від <?=$today?> про нові види операцій з дорогоцінними металами і дорогоцінним камінням за місцем провадження діяльності на 1 арк. в 1 прим.
			</div></td></tr>
			</table>
			<br><br>
