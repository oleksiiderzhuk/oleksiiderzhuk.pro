...
$passport_info=$person['passport_info'];
...
<div class="container">
	<div class="row" style="margin-top: 60px; ">
		<div class="col-md-12" style="height: 1000px;">
			<h3>Редагування фізичної особи-підприємця в реєстрі суб'єктів господарювання</h3>
			<form style="margin-top: 40px;" method="post" action="edit_sub.php">
				<div class="form-row">
					<div class="form-group col-md-2">
						<label for="regno">Номер в реєстрі</label>
						<input type="number" class="form-control" id="regno" placeholder="№" name="regno" value="<?=$regno?>" style="letter-spacing: 0.2em;" required>
						<input type="hidden" name="id" value="<?=$id?>">
					</div>
					<div class="form-group col-md-8">
						<label for="name">Прізвище ім'я по-батькові</label>
						<input type="text" class="form-control" id="name" placeholder="Прізвище ім'я по-батькові" name="name" value="<?=$name?>" required>
					</div>
				</div>
				<div class="form-row">
					<div class="form-group col-md-3">
						<label for="tax_code">Ідентифікаційний номер</label>
						<input type="number" class="form-control" id="tax_code" placeholder="Ідентифікаційний номер" name="tax_code" value="<?=$edrpou?>" style="letter-spacing: 0.2em;" required>
					</div>
					<div class="form-group col-md-9">
						<label for="passport_info">Серія, номер паспорта або УНЗР, ким коли виданий</label>
						<input type="text" class="form-control" id="passport_info" placeholder="Серія, номер паспорта або УНЗР" name="passport_info" value="<?=$passport_info?>">
					</div>
				</div>
				...
				<div class="form-row" style="margin-top: 20px;">
					<div class="form-group col-md-3">
						...
						<input type="date" class="form-control" name="regdate"  value="<?php if($reg_date!=='1970-01-01') echo $reg_date; ?>">
					</div>
