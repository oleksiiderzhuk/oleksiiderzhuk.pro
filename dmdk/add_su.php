...
//Записываем информацию в person
	$sql = "INSERT INTO person (id, version, person_id, regno, isjur, name, tax_code, passport_info, opf_id, reg, regdate, edit_name, date_start, date_end, state) VALUES (1, $max_person_id, '$regno', '$isjur', '$name', '$tax_code', '$passport_info', $opf_id, '$reg', '$regdate', '$edit_name', '$current_date', '6666-07-13 13:13:13', '1');";
