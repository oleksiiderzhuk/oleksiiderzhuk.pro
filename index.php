...
<div class="row" style="text-align: center">
    <div class="col-md-6 col-xs-12" style="margin-top: 30px" style="font-family: arial, sans-serif">
        <h5> Information system for acсounting </h5>
        <object data="img/col_dmdk_eng.svg" type="image/svg+xml" id="imap" width="100%" height="100%" style="margin-top: -10px"></object>
    </div>


    <div class="col-md-6 col-xs-12" style="margin-top: 30px">
        <h5> Office building interactive map </h5>
        <object data="img/areas_eng.svg" type="image/svg+xml" id="imap" width="100%" height="100%" style="margin-top: -15px"></object>
    </div>
...
<div class="row" style="text-align: center">
    ...
    <div class="col-sm-6 col-xs-12">
        <br>
        <center>
            <h5>2020<br>Coursera / Univercity of Michigan <br>Building Database Applications in PHP: CRUD</h5>
        </center>
        <a href="https://coursera.org/share/a504fcac0a6989cbbc0264d44a842de3">
    ...
    <!--
        <div class="col-sm-4 col-xs-12">
            <img src="{{ asset('img/kpi1.jpg') }}" width=80% >
        </div>
-->
